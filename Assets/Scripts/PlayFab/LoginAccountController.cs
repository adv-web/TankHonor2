...
public class LoginAccountController: MonoBehaviour {
	...
	void OnEnable(){
		errorMessage.text = "";
        account.text = PlayerPrefs.GetString("Account", "");    //获取玩家上次登录成功的账号信息PlayerPrefs: built-in class in Unity: Stores and accesses player preferences between game sessions.
        password.text = "";
	...
	public void ClickLoginButton(){
         ...
         */
		//loginingWindow.SetActive(true);            //启用账号登录中提示窗口
